...
class helloImpl3 extends helloPOA
{
	private ORB orb;
  ...
  public static void main(String[] args) 	 
   {
	  try 
	  {
		  ...
		  helloImpl3 helloImpl3 = new helloImpl3();
		  helloImpl3.setORB(orb);
		  
		  org.omg.CORBA.Object ref = rootpoa.servant_to_reference(helloImpl3);
		  ...
		  System.out.println("Tor running and waiting");
		  orb.run();
	  }
	  catch(Exception e)
	  {
