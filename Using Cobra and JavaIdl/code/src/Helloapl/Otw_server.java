...
class helloImpl2 extends helloPOA
{
	private ORB orb;
		  ...
		  {  
	        ...
	        else
	        {
	        	if(eventID.startsWith("OTW"))
	                ...
	                msg=eventID+" Event successfully Added";
...
public String bookEvent(String customerID, String eventID, String eventType)
{
  ...
  if(eventID.substring(0,3).equalsIgnoreCase("OTW")) 
  {
							...
							if(eve>0) 
							 {
									...
									rly="Booking for "+eventID+" is successful for the " +customerID;
	...
	public String swapEvent(String customerID, String newEventID, String newEventType, String oldEventID, String oldEventType)
	{
		...
		System.out.println(msg);
		if(msg.equalsIgnoreCase(oldEventID+" Event has been removed."))
		{
			msg=bookEvent(customerID,newEventID,newEventType);
			if(msg.equalsIgnoreCase("Booking for "+newEventID+" is successful for the " +customerID)) 
			{
				msg="Events are Swapped Successfully";
				return msg;
		    }
		    else
		    {
			  String msg1=bookEvent(customerID,oldEventID,oldEventType);
				return msg+" ,So swapping unsuccessful.";
		...
		try 
		  {
			  ...
			  helloImpl2 helloImpl2 = new helloImpl2();
			  helloImpl2.setORB(orb);
			  
			  org.omg.CORBA.Object ref = rootpoa.servant_to_reference(helloImpl2);
			  ...
			  System.out.println("Otw running and waiting");
			  orb.run();
		  }
		  catch(Exception e)
		  {
