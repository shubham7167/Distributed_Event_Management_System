...
class helloImpl1 extends helloPOA
{
	private ORB orb;
		...
		try 
		  {
			  ...
			  helloImpl1.setORB(orb);
			  
			  org.omg.CORBA.Object ref = rootpoa.servant_to_reference(helloImpl1);
			  ...
			  System.out.println("Mtl running and waiting");
			  orb.run();
		  }
		  catch(Exception e)
		  {
